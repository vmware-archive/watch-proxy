...
func StartWatchers(client *kubernetes.Clientset, crdClient *crdClient.Clientset, c config.Config,
	...
	for _, resource := range resources {
		ic, err := NewInformerClient(client, crdClient, resource.Name, "", processorQueue, c)
		if err != nil {
