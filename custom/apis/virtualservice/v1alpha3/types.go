...
import (
	...
	util "github.com/heptio/quartermaster/util"
...
type HTTPMatchRequest struct {
	...
	//
	Uri *util.StringMatch `json:"uri,omitempty"`
	...
	// - `regex: "value"` for ECMAscript style regex-based match
	//
	Scheme *util.StringMatch `json:"scheme,omitempty"`
	...
	// - `regex: "value"` for ECMAscript style regex-based match
	//
	Method *util.StringMatch `json:"method,omitempty"`
	...
	// - `regex: "value"` for ECMAscript style regex-based match
	//
	Authority *util.StringMatch `json:"authority,omitempty"`
	...
	Headers map[string]util.StringMatch `json:"headers,omitempty"`
}
